 ...
 *     tags:
 *       - Auth
 *     summary: Auto-login using centralized session
 *     description: Validates the centralized auth session from request headers and creates/fetches a local user.
 *     responses:
 *       200:
...
export async function GET(req: Request) {
  ...
  return authController.autoLogin(req)
}
