...
## ENV
NEXT_PRIVATE_CENTRALIZED_AUTH_BACKEND_URL=https://auth-app.omnisai.io

NEXT_PRIVATE_CENTRALIZED_AUTH_FRONTEND_URL=https://auth.omnisai.io

NEXT_PRIVATE_API_BASE_URL=http://localhost:3011

NEXT_PRIVATE_DB_HOST=localhost

NEXT_PRIVATE_DB_PORT=5432

NEXT_PRIVATE_DB_USER=postgres    

NEXT_PRIVATE_DB_PASSWORD=postgres

NEXT_PRIVATE_DB_NAME=esign
...
NEXT_PRIVATE_UPLOAD_BUCKET='esignature-bucket-1755067892'

NEXT_PRIVATE_UPLOAD_TRANSPORT='s3'

NEXT_PRIVATE_UPLOAD_SECRET_ACCESS_KEY='zVsDefOntIQ2W097GUcF1DTmx3sN+STWkH54T8XH'

NEXT_PRIVATE_UPLOAD_ACCESS_KEY_ID='AKIA5NIQA6VLOKGRTMVO'
...
NEXT_PRIVATE_SMTP_USER=94cc89001@smtp-brevo.com

NEXT_PRIVATE_SMTP_PASS=cY9OWnyIkS6E7RdK

NEXT_PRIVATE_SMTP_FROM='no-reply@omnisai.io'

NEXT_PRIVATE_JWT_SECRET='L2I;MrCIDdIJ[X&'
